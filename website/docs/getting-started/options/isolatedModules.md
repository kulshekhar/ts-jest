---
title: TypeScript isolatedModules compiler option
---
...
That's what TypeScript's `compilerOptions.isolatedModules` option (which defaults to `false`) does.
...
Here is how to configure TypeScript to disable type-checking and compile each file as an isolated module:
